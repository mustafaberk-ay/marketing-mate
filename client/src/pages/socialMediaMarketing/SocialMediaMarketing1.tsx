...
function SocialMediaMarketingPage1() {
	...
	function isRequestedImageInputOnChange(e: React.ChangeEvent<HTMLInputElement>){
				...
				<div>
					...
					<div className='flex flex-col justify-around h-screen pl-10 pr-10'>
						...
						<div className='text-white text-3xl '>
							Step 1: Product and Post Details
						</div>
...
export default SocialMediaMarketingPage1;
