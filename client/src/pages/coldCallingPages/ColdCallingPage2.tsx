...
function ColdCallingPage2() {
	...
	async function generateButtonOnClick() {
		...
		console.log(`generate button clicked ${generateAgainClickCount} times`);
					...
					<div>
						...
						<div className='flex flex-col justify-around h-screen pl-10 pr-10'>
							...
							<div className='text-lightBrown text-center text-2xl'>
								If you don’t like this script, click “Generate Again” or edit
								the text above. Otherwise, continue with the “Next Step”.
							</div>
							...
							<div className='flex justify-between'>
								...
								{isGeneratedContentValid() ? (
									...
									<button onClick={nextStepButtonOnClick} className='pointer-events-none'>
										<NextStepButton nextStepPath='/cold-calling-3' />
									</button>
								)}
							</div>
...
export default ColdCallingPage2;
